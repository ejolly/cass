...
{
	if (region.b7.bd === region.cx.bd)
	{
		return 'on line ' + region.b7.bd;
	}
	return 'on lines ' + region.b7.bd + ' through ' + region.cx.bd;
}
...
function _Browser_application(impl)
{
	...
	return _Browser_document({
		...
		d1: function(flags)
		{
			return A3(impl.d1, flags, _Browser_getUrl(), key);
		},
		eK: impl.eK,
		eI: impl.eI,
		eA: impl.eA
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dY: 'hidden', dD: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dY: 'mozHidden', dD: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dY: 'msHidden', dD: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dY: 'webkitHidden', dD: 'webkitvisibilitychange' }
		: { dY: 'hidden', dD: 'visibilitychange' };
}
...
function _Browser_getViewport()
{
	return {
		...
		dt: {
			...
			eL: _Browser_doc.documentElement.clientWidth,
...
function _Browser_getScene()
{
	...
	return {
		eL: Math.max(body.scrollWidth, body.offsetWidth, elem.scrollWidth, elem.offsetWidth, elem.clientWidth),
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cS, request.ca, true);
		} catch (e) {
...
{
	for (var headers = request.cD; headers.b; headers = headers.b) // WHILE_CONS
	{
...
function _Http_toMetadata(xhr)
{
	return {
		...
		ey: xhr.status,
		ez: xhr.statusText,
		cD: _Http_parseHeaders(xhr.getAllResponseHeaders())
	};
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cC: fragment, cG: host, c_: path, c0: port_, c4: protocol, c5: query};
	});
...
var $author$project$Main$GotTables = function (a) {
	return {$: 0, a: a};
};
	...
	function (toResult, response) {
		switch (response.$) {
			...
			case 3:
				...
				return $elm$core$Result$Err(
					$elm$http$Http$BadStatus(metadata.ey));
			default:
				var body = response.b;
				return A2(
...
var $elm$http$Http$onEffects = F4(
	function (router, cmds, subs, state) {
		return A2(
			...
			A3($elm$http$Http$updateReqs, router, cmds, state.c8));
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{dw: false, cl: r.cl, dS: r.dS, cD: r.cD, cS: r.cS, dm: r.dm, dn: r.dn, ca: r.ca}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{cl: $elm$http$Http$emptyBody, dS: r.dS, cD: _List_Nil, cS: 'GET', dm: $elm$core$Maybe$Nothing, dn: $elm$core$Maybe$Nothing, ca: r.ca});
};
var $author$project$Main$TableInfo = F2(
	function (name, tableType) {
		return {A: name, eB: tableType};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$list = _Json_decodeList;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$tablesDecoder = A2(
	$elm$json$Json$Decode$field,
	'tables',
	$elm$json$Json$Decode$list(
		A3(
			$elm$json$Json$Decode$map2,
			$author$project$Main$TableInfo,
			A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
			A2($elm$json$Json$Decode$field, 'type', $elm$json$Json$Decode$string))));
var $author$project$Main$fetchTables = $elm$http$Http$get(
	{
		dS: A2($elm$http$Http$expectJson, $author$project$Main$GotTables, $author$project$Main$tablesDecoder),
		ca: '/api/tables'
	});
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{ah: $elm$core$Maybe$Nothing, D: $elm$core$Maybe$Nothing, aN: _List_Nil, aO: $elm$core$Maybe$Nothing, aP: '', as: $elm$core$Maybe$Nothing, aQ: false, aS: _List_Nil},
		$author$project$Main$fetchTables);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Main$GridMsg = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Main$estimateWidth = F2(
...
var $author$project$Main$hiddenColumns = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'canvas_assignments',
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{cr: col, f: s0.f, g: s0.g, bf: offset, dc: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.bf, s.dc, s.cr, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cr: col, dK: contextStack, c1: problem, dc: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.dc, s.cr, x, s.f));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.bf, s.dc, s.cr, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cr: newCol, f: s.f, g: s.g, bf: newOffset, dc: newRow, a: s.a});
	};
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$Filters$makeFilter = function (_v0) {
	...
	var equal = _v0.K;
	var lessThan = _v0.N;
	var greaterThan = _v0.L;
	var contains = _v0.J;
	var typedParser = _v0.bn;
	return {
		J: {
			T: F2(
				function (value, item) {
			...
			_: A2($elm$parser$Parser$keeper, $Orange_OpenSource$elm_advanced_grid$Grid$Parsers$containsParser, typedParser)
		},
		K: {
			T: F2(
				function (value, item) {
			...
			_: A2($elm$parser$Parser$keeper, $Orange_OpenSource$elm_advanced_grid$Grid$Parsers$equalityParser, typedParser)
		},
		L: {
			T: F2(
				function (value, item) {
			...
			_: A2($elm$parser$Parser$keeper, $Orange_OpenSource$elm_advanced_grid$Grid$Parsers$greaterThanParser, typedParser)
		},
		N: {
			T: F2(
				function (value, item) {
			...
			_: A2($elm$parser$Parser$keeper, $Orange_OpenSource$elm_advanced_grid$Grid$Parsers$lessThanParser, typedParser)
		}
	};
};
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.bf, s.dc, s.cr, s.a);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		...
		return A3(
			$elm$parser$Parser$Advanced$Good,
			_Utils_cmp(s.bf, adjustedOffset) < 0,
			0,
			{cr: newCol, f: s.f, g: s.g, bf: adjustedOffset, dc: newRow, a: s.a});
	};
};
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.bf, s1.bf, s0.a),
						a),
					s1);
			}
		};
	...
	return $Orange_OpenSource$elm_advanced_grid$Grid$Filters$makeFilter(
		{
			...
			bn: $Orange_OpenSource$elm_advanced_grid$Grid$Parsers$stringParser
		});
};
...
var $rtfeldman$elm_css$Css$contentBox = {bV: 0, bt: 0, Q: 'content-box'};
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.dN) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.A, record.dN, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	...
	return {cp: charset, dO: finalDeclarations, cI: imports, cV: namespaces};
};
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {az: charsProcessed, aH: hash, ar: seed, ex: shift};
	});
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$finalize = function (data) {
	var acc = (!(!data.aH)) ? (data.ar ^ A2(
		...
		A2(
			...
			15,
			A2($rtfeldman$elm_css$ElmCssVendor$Murmur3$multiplyBy, $rtfeldman$elm_css$ElmCssVendor$Murmur3$c1, data.aH)))) : data.ar;
	var h0 = acc ^ data.az;
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$hashFold = F2(
	function (c, data) {
		var res = data.aH | ((255 & $elm$core$Char$toCode(c)) << data.ex);
		var _v0 = data.ex;
		if (_v0 === 24) {
			return {
				az: data.az + 1,
			...
			return {az: data.az + 1, aH: res, ar: data.ar, ex: data.ex + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {cp: charset, dO: declarations, cI: imports, cV: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {cp: $elm$core$Maybe$Nothing, cI: _List_Nil, cV: _List_Nil, dg: snippets};
};
...
var $rtfeldman$elm_css$Css$hidden = {u: 0, aM: 0, Q: 'hidden', bq: 0};
var $rtfeldman$elm_css$Css$inlineFlex = {k: 0, Q: 'inline-flex'};
...
var $rtfeldman$elm_css$Css$noWrap = {a7: 0, bz: 0, Q: 'nowrap', ae: 0};
...
var $rtfeldman$elm_css$Css$solid = {u: 0, at: 0, Q: 'solid'};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$cellAttributes = function (properties) {
	return _List_fromArray(
		[
			A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-testid', properties.d_),
			...
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Css$px(properties.eL - $Orange_OpenSource$elm_advanced_grid$Grid$cumulatedBorderWidth))
				]))
		]);
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$stringColumnConfig = function (properties) {
	var id = properties.d_;
	var title = properties.eF;
	var tooltip = properties.eG;
	var width = properties.eL;
	var getter = properties.dV;
	var localize = properties.ea;
	var nestedDataGetter = A2(
		...
		getter);
	return {
		B: $Orange_OpenSource$elm_advanced_grid$Grid$compareFields(nestedDataGetter),
		x: $elm$core$Maybe$Nothing,
		ai: $Orange_OpenSource$elm_advanced_grid$Grid$Filters$StringFilter(
		...
		aq: $Orange_OpenSource$elm_advanced_grid$Grid$viewString(nestedDataGetter),
		aX: nestedDataGetter
	};
};
var $author$project$Main$buildGridColumns = F3(
	function (colNames, colTypes, tableName) {
		var hidden = A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			A2($elm$core$Dict$get, tableName, $author$project$Main$hiddenColumns));
		return A2(
			$elm$core$List$filterMap,
			$elm$core$Basics$identity,
			A2(
				...
				F2(
					function (i, colName) {
						if (A2($elm$core$List$member, colName, hidden)) {
							...
							var width = A2($author$project$Main$estimateWidth, colName, colType);
							return $elm$core$Maybe$Just(
								$Orange_OpenSource$elm_advanced_grid$Grid$stringColumnConfig(
									{
										dV: function (row) {
											return A2(
												$elm$core$Maybe$withDefault,
												'',
												A2($elm$core$Dict$get, colName, row.ds));
										},
										d_: colName,
...
var $author$project$Main$GotSchemaAndData = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
...
var $author$project$Main$resolveJson = F2(
...
var $author$project$Main$ColumnSchema = F3(
	function (name, colType, nullable) {
		return {dF: colType, A: name, ed: nullable};
	});
var $author$project$Main$TableSchema = F5(
	function (table, columns, primaryKeys, editable, canvasPushable) {
		return {dC: canvasPushable, af: columns, cv: editable, ep: primaryKeys, dj: table};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $elm$json$Json$Decode$map3 = _Json_map3;
var $elm$json$Json$Decode$map5 = _Json_map5;
var $author$project$Main$schemaDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Main$TableSchema,
	...
	A2(
		...
		$elm$json$Json$Decode$list(
			A4(
				...
				$author$project$Main$ColumnSchema,
				A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
				A2($elm$json$Json$Decode$field, 'type', $elm$json$Json$Decode$string),
...
var $author$project$Main$TableData = F4(
	function (table, columns, types, rows) {
		return {af: columns, aN: rows, dj: table, dr: types};
	});
var $elm$json$Json$Decode$map4 = _Json_map4;
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Main$tableDataDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Main$TableData,
	A2($elm$json$Json$Decode$field, 'table', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'columns',
...
var $elm$http$Http$task = function (r) {
	return A3(
		...
		{dw: false, cl: r.cl, dS: r.db, cD: r.cD, cS: r.cS, dm: r.dm, dn: $elm$core$Maybe$Nothing, ca: r.ca});
};
var $author$project$Main$fetchSchemaAndData = function (name) {
	var schemaTask = $elm$http$Http$task(
		{
			...
			db: $elm$http$Http$stringResolver(
				$author$project$Main$resolveJson($author$project$Main$schemaDecoder)),
	...
	var dataTask = $elm$http$Http$task(
		{
			...
			cS: 'GET',
			db: $elm$http$Http$stringResolver(
				$author$project$Main$resolveJson($author$project$Main$tableDataDecoder)),
			dm: $elm$core$Maybe$Nothing,
			ca: '/api/table/' + name
		});
	return A2(
		$elm$core$Task$attempt,
		$author$project$Main$GotSchemaAndData(name),
...
var $Orange_OpenSource$elm_advanced_grid$Grid$Item$create = F2(
	function (data, index) {
		return {a4: data, cJ: index, P: false};
	});
...
var $Orange_OpenSource$elm_advanced_grid$Grid$selectionColumn = function () {
	...
	return {
		B: $Orange_OpenSource$elm_advanced_grid$Grid$compareBoolField(
			function ($) {
				return $.P;
			}),
		x: $elm$core$Maybe$Nothing,
		ai: $Orange_OpenSource$elm_advanced_grid$Grid$Filters$NoFilter,
		b: $Orange_OpenSource$elm_advanced_grid$Grid$columnConfigProperties(properties),
		aq: $Orange_OpenSource$elm_advanced_grid$Grid$viewBool(
			function ($) {
				return $.P;
			}),
		aX: A2(
...
var $Orange_OpenSource$elm_advanced_grid$Grid$isSelectionColumnProperties = function (columnProperties) {
	return _Utils_eq(columnProperties.d_, $Orange_OpenSource$elm_advanced_grid$Grid$selectionColumn.b.d_);
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$init = F2(
	function (config, data) {
		...
		var shouldAddSelectionColumn = config.dB && (!hasSelectionColumn(config.af));
		var newConfig = shouldAddSelectionColumn ? _Utils_update(
			config,
			{
				af: A2($elm$core$List$cons, $Orange_OpenSource$elm_advanced_grid$Grid$selectionColumn, config.af)
			}) : config;
		var sanitizedConfig = _Utils_update(
			newConfig,
			{
				af: $Orange_OpenSource$elm_advanced_grid$Grid$sanitizedColumns(newConfig.af)
			});
		var initialModel = {
			...
			bB: $FabienHenon$elm_infinite_list_view$InfiniteList$init,
			bD: false,
			an: 0,
		...
		return _Utils_update(
			initialModel,
			{
				aB: $Orange_OpenSource$elm_advanced_grid$Grid$columnsX(initialModel)
			});
	});
var $elm$core$Platform$Cmd$map = _Platform_map;
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$Row = function (values) {
	return {ds: values};
};
...
var $author$project$Main$jsonValueToString = function (val) {
...
var $author$project$Main$parseRows = function (tableData) {
	return A2(
		$elm$core$List$map,
		function (rawRow) {
			var pairs = A3(
				...
				F2(
					function (colName, val) {
						return _Utils_Tuple2(
							colName,
							$author$project$Main$jsonValueToString(val));
					}),
				tableData.af,
				rawRow);
			return $author$project$Main$Row(
...
var $FabienHenon$elm_infinite_list_view$InfiniteList$config = function (conf) {
	return {bu: $elm$core$Maybe$Nothing, dI: conf.dI, a3: $FabienHenon$elm_infinite_list_view$InfiniteList$defaultContainer, d_: $elm$core$Maybe$Nothing, bE: conf.bE, a9: conf.a9, bb: 0, bf: 200, bS: _List_Nil};
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$gridWidth = function (model) {
	return A3(
		...
		function (columnConfig) {
			return $elm$core$Basics$add(columnConfig.b.eL);
		},
		0,
		$Orange_OpenSource$elm_advanced_grid$Grid$visibleColumns(model));
};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewColumn = F2(
	function (config, item) {
		return A2(config.aq, config.b, item);
	});
					...
					[
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Css$px(model.h.d8)),
								$rtfeldman$elm_css$Css$width(
...
var $Orange_OpenSource$elm_advanced_grid$Grid$infiniteListConfig = function (model) {
	return A2(
		...
		$FabienHenon$elm_infinite_list_view$InfiniteList$config(
			{
				dI: model.h.dI,
				bE: $FabienHenon$elm_infinite_list_view$InfiniteList$withConstantHeight(model.h.d8),
				a9: $Orange_OpenSource$elm_advanced_grid$Grid$viewRow(model)
			}));
};
...
var $elm$core$Array$appendHelpBuilder = F2(
	function (tail, builder) {
		...
		} : {p: builder.p, l: builder.l, n: appended});
	});
		...
		while (true) {
			...
			if (_Utils_cmp(
				...
				return A2(
					$elm$core$Array$builderToArray,
					true,
					{p: nodeList, l: nodeListSize, n: jsArray});
			} else {
			...
			case 2:
				return _Utils_Tuple2(
					$elm$core$List$reverse(
						A2($elm$core$List$sortWith, columnConfig.B, model.o)),
					2);
			case 1:
				return _Utils_Tuple2(
					A2($elm$core$List$sortWith, columnConfig.B, model.o),
					1);
			default:
				return _Utils_Tuple2(model.o, 0);
		}
	});
...
var $Orange_OpenSource$elm_advanced_grid$Grid$updateColumnWidthProperty = F3(
	function (model, columnConfig, width) {
		...
		return A3($Orange_OpenSource$elm_advanced_grid$Grid$updateColumnProperties, setWidth, model, columnConfig.b.d_);
	});
var $Orange_OpenSource$elm_advanced_grid$Grid$withColumnsX = function (model) {
	return _Utils_update(
		model,
		{
			aB: $Orange_OpenSource$elm_advanced_grid$Grid$columnsX(model)
		});
};
		...
		return $Orange_OpenSource$elm_advanced_grid$Grid$withColumnsX(
			A2(
				...
				_Utils_update(
					config,
					{
						af: $Orange_OpenSource$elm_advanced_grid$Grid$sanitizedColumns(columns)
					}),
				model));
	});
var $Orange_OpenSource$elm_advanced_grid$Grid$resizeColumn = F2(
	function (model, x) {
		...
		if (!_v0.$) {
			...
			var deltaX = x - model.aC;
			var newWidth = columnConfig.b.eL + $elm$core$Basics$round(deltaX);
			var newColumns = (_Utils_cmp(newWidth, $Orange_OpenSource$elm_advanced_grid$Grid$minColumnWidth) > 0) ? A3($Orange_OpenSource$elm_advanced_grid$Grid$updateColumnWidthProperty, model, columnConfig, newWidth) : model.h.af;
...
var $Orange_OpenSource$elm_advanced_grid$Grid$setFilter = F2(
	function (filterValues, columnConfig) {
		var value = A2($elm$core$Dict$get, columnConfig.b.d_, filterValues);
		return _Utils_update(
			columnConfig,
			{x: value});
	});
...
var $Orange_OpenSource$elm_advanced_grid$Grid$sort = F4(
	function (model, columnConfig, order, sorter) {
		...
		return _Utils_update(
			...
			{
				an: newOrder,
				bj: $elm$core$Maybe$Just(columnConfig),
				o: updatedItems
			});
	});
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {cr: col, c1: problem, dc: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.dc, p.cr, p.c1);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{cr: 1, f: _List_Nil, g: 1, bf: 0, dc: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $Orange_OpenSource$elm_advanced_grid$Grid$Filters$validateContainsFilter = F2(
	function (filters, filteringString) {
		return A2(
			$elm$core$Result$map,
			filters.J.T,
			A2($elm$parser$Parser$run, filters.J._, filteringString));
	});
var $Orange_OpenSource$elm_advanced_grid$Grid$Filters$validateEqualFilter = F2(
	function (filters, filteringString) {
		return A2(
			$elm$core$Result$map,
			filters.K.T,
			A2($elm$parser$Parser$run, filters.K._, filteringString));
	});
var $Orange_OpenSource$elm_advanced_grid$Grid$Filters$validateGreaterThanFilter = F2(
	function (filters, filteringString) {
		return A2(
			$elm$core$Result$map,
			filters.L.T,
			A2($elm$parser$Parser$run, filters.L._, filteringString));
	});
var $Orange_OpenSource$elm_advanced_grid$Grid$Filters$validateLessThanFilter = F2(
	function (filters, filteringString) {
		return A2(
			$elm$core$Result$map,
			filters.N.T,
			A2($elm$parser$Parser$run, filters.N._, filteringString));
	});
...
var $Orange_OpenSource$elm_advanced_grid$Grid$columnFilters = function (model) {
	return A2(
		$elm$core$List$filterMap,
		function (c) {
			return A2($Orange_OpenSource$elm_advanced_grid$Grid$Filters$parseFilteringString, c.x, c.ai);
		},
		model.h.af);
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 13:
				...
				var draggedColumn = {a2: columnConfig, aC: mousePosition.r, bF: '', r: mousePosition.r};
				return A2(
			...
			case 10:
				var columnConfig = msg.a;
				return model.a6 ? model : A4($Orange_OpenSource$elm_advanced_grid$Grid$sort, model, columnConfig, model.an, $Orange_OpenSource$elm_advanced_grid$Grid$toggleOrder);
			case 12:
				var item = msg.a;
				return _Utils_update(
					model,
					{
						bW: $elm$core$Maybe$Just(item)
					});
			case 15:
				return _Utils_update(
					model,
			...
			case 16:
				...
				return _Utils_update(
					...
					{
						aC: position.r,
						ab: $elm$core$Maybe$Just(columnConfig)
					});
			case 17:
			...
			case 18:
				return _Utils_update(
					model,
					{C: $elm$core$Maybe$Nothing, ab: $elm$core$Maybe$Nothing});
			case 14:
				return model;
			case 19:
				var position = msg.a;
				return A2($Orange_OpenSource$elm_advanced_grid$Grid$resizeColumn, model, position.r);
			case 20:
				var columnConfig = msg.a;
				...
				if (!_v3.$) {
					...
					if (_Utils_eq(columnConfig.b.d_, draggedColumn.bF)) {
						return model;
					} else {
						var newColumns = A3($Orange_OpenSource$elm_advanced_grid$Grid$moveColumn, columnConfig, draggedColumnConfig, model.h.af);
						return A2(
							$Orange_OpenSource$elm_advanced_grid$Grid$withDraggedColumn,
							$elm$core$Maybe$Just(
								_Utils_update(
									draggedColumn,
									{bF: columnConfig.b.d_})),
			...
			case 21:
				var newStatus = !model.bD;
				var setSelectionStatus = function (item) {
					return _Utils_update(
						item,
						{P: newStatus});
				};
				var updatedVisibleItems = A2($elm$core$List$map, setSelectionStatus, model.o);
				return _Utils_update(
					model,
					{bD: newStatus, o: updatedVisibleItems});
			case 22:
				var columnConfig = msg.a;
				...
				var newColumns = A3(
					...
					A3($Orange_OpenSource$elm_advanced_grid$Grid$updateColumnProperties, toggleVisibility, model, columnConfig.b.d_));
				var updatedModel = A2($Orange_OpenSource$elm_advanced_grid$Grid$withColumns, newColumns, model);
				return _Utils_update(
					updatedModel,
					{
						aB: $Orange_OpenSource$elm_advanced_grid$Grid$columnsX(updatedModel)
					});
			default:
				var item = msg.a;
				var newItems = A3(
...
var $FabienHenon$elm_infinite_list_view$InfiniteList$computeElementsAndSizesForMultipleHeights = F4(
	function (_v0, getHeight, scrollTop, items) {
		var offset = _v0.bf;
		var containerHeight = _v0.dI;
		var keepFirst = _v0.bb;
		var updateComputations = F2(
			function (item, calculatedTuple) {
				var _v1 = calculatedTuple;
				var idx = _v1.aI;
				var elementsCountToSkip = _v1.by;
				var elementsToShow = _v1.a5;
				var topMargin = _v1.ac;
				...
				return ((_Utils_cmp(
					...
					{
						ag: newCurrentHeight,
						a5: A2($elm$core$List$cons, item, elementsToShow),
						aI: idx + 1
					}) : ((_Utils_cmp(
					newCurrentHeight,
					$elm$core$Basics$ceiling(scrollTop) - offset) < 1) ? _Utils_update(
					calculatedTuple,
					{ag: newCurrentHeight, by: elementsCountToSkip + 1, aI: idx + 1, ac: topMargin + height}) : ((_Utils_cmp(
					currentHeight,
					...
					calculatedTuple,
					{ag: newCurrentHeight, aI: idx + 1})));
			});
		var initialValue = {ag: 0, by: 0, a5: _List_Nil, aI: 0, ac: 0};
		var computedValues = A3($FabienHenon$elm_infinite_list_view$InfiniteList$iterator_foldl, updateComputations, initialValue, items.ba);
		return {
			bx: $elm$core$List$reverse(computedValues.a5),
			bR: computedValues.by,
			ac: computedValues.ac,
			bm: computedValues.ag
		};
	});
var $FabienHenon$elm_infinite_list_view$InfiniteList$computeElementsAndSizesForSimpleHeight = F4(
	function (_v0, itemHeight, scrollTop, items) {
		...
		var containerHeight = _v0.dI;
		var keepFirst = _v0.bb;
		var totalHeight = items.bc(0) * itemHeight;
		...
		var elementsToShow = _Utils_ap(
			A2(items.aW, 0, keepFirst),
			A2(items.aW, keepFirst + elementsCountToSkip, (keepFirst + elementsCountToSkip) + elementsCountToShow));
		return {bx: elementsToShow, bR: elementsCountToSkip, ac: topMargin, bm: totalHeight};
	});
var $FabienHenon$elm_infinite_list_view$InfiniteList$computeElementsAndSizes = F3(
	function (configValue, scrollTop, items) {
		var itemHeight = configValue.bE;
		var itemView = configValue.a9;
		var customContainer = configValue.a3;
		if (!itemHeight.$) {
...
var $FabienHenon$elm_infinite_list_view$InfiniteList$firstNItemsHeight = F3(
	function (idx, configValue, items) {
		var _v0 = A3(
			...
			0,
			{
				ba: $FabienHenon$elm_infinite_list_view$InfiniteList$listIter(items),
				bc: function (_v1) {
		...
		var totalHeight = _v0.bm;
		return totalHeight;
	});
var $elm$browser$Browser$Dom$setViewportOf = _Browser_setViewportOf;
var $FabienHenon$elm_infinite_list_view$InfiniteList$scrollToNthItem = function (_v0) {
	var postScrollMessage = _v0.en;
	var listHtmlId = _v0.d9;
	var itemIndex = _v0.d4;
	var configValue = _v0.dG;
	var items = _v0.d5;
	return A2(
		$elm$core$Task$attempt,
		function (_v1) {
		...
		switch (msg.$) {
			...
			case 8:
				...
				var targetItemIndex = A2(
					$elm$core$Maybe$withDefault,
					0,
					A2($elm_community$list_extra$List$Extra$findIndex, isTargetItem, model.o));
				return _Utils_Tuple2(
					model,
					$FabienHenon$elm_infinite_list_view$InfiniteList$scrollToNthItem(
						{
							dG: $Orange_OpenSource$elm_advanced_grid$Grid$infiniteListConfig(model),
							d4: targetItemIndex,
							d5: model.o,
							d9: $Orange_OpenSource$elm_advanced_grid$Grid$gridHtmlId,
							en: $Orange_OpenSource$elm_advanced_grid$Grid$NoOp
						}));
			default:
				return _Utils_Tuple2(
		...
		switch (msg.$) {
					...
					return _Utils_Tuple2(
						...
						function () {
							if (!firstTable.$) {
								...
								return $author$project$Main$fetchSchemaAndData(name);
							} else {
			...
			case 1:
				...
				return _Utils_eq(
					...
					$author$project$Main$fetchSchemaAndData(name));
			case 2:
				var name = msg.a;
				var result = msg.b;
				if (!result.$) {
					...
					var schema = _v4.a;
					var tableData = _v4.b;
					var rows = $author$project$Main$parseRows(tableData);
					var columns = A3($author$project$Main$buildGridColumns, tableData.af, tableData.dr, name);
					var gridConfig = {
						dB: false,
						af: columns,
						dI: 800,
					...
					var gridModel = A2($Orange_OpenSource$elm_advanced_grid$Grid$init, gridConfig, rows);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								ah: $elm$core$Maybe$Nothing,
								D: $elm$core$Maybe$Just(gridModel),
								aN: rows,
								aO: $elm$core$Maybe$Just(schema),
								as: $elm$core$Maybe$Just(name)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
			...
			case 3:
				...
				if (!_v6.$) {
					var gm = _v6.a;
					var _v7 = A2($Orange_OpenSource$elm_advanced_grid$Grid$update, gridMsg, gm);
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								D: $elm$core$Maybe$Just(newGridModel)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$GridMsg, gridCmd));
				} else {
				...
				if (!_v8.$) {
					...
					var filters = $elm$core$String$isEmpty(newText) ? $elm$core$Dict$empty : $elm$core$Dict$fromList(
						A2(
							$elm$core$List$map,
							function (c) {
								return _Utils_Tuple2(c.A, newText);
							},
							A2(
								$elm$core$Maybe$withDefault,
								_List_Nil,
...
var $rtfeldman$elm_css$Css$auto = {dv: 0, c: 0, aE: 0, bC: 0, d6: 0, aJ: 0, X: 0, M: 0, aM: 0, G: 0, bT: 0, aV: 0, y: 0, Q: 'auto'};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$defaultOptions = {b5: true, b8: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {dA: button, cq: clientPos, d7: keys, ee: offsetPos, ei: pagePos, et: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F3(
	function (alt, ctrl, shift) {
		return {dx: alt, dL: ctrl, ex: shift};
	});
...
var $rtfeldman$elm_css$Css$relative = {bg: 0, Q: 'relative'};
var $rtfeldman$elm_css$Css$absolute = {bg: 0, Q: 'absolute'};
...
var $rtfeldman$elm_css$Css$row = {b_: 0, a7: 0, Q: 'row'};
...
var $rtfeldman$elm_css$Css$visible = {aM: 0, G: 0, Q: 'visible', bq: 0};
	...
	return $rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
				...
				$rtfeldman$elm_css$Css$boxSizing($rtfeldman$elm_css$Css$contentBox),
				$rtfeldman$elm_css$Css$height(
				$rtfeldman$elm_css$Css$px(model.h.dX - $Orange_OpenSource$elm_advanced_grid$Grid$cumulatedBorderWidth)),
...
var $rtfeldman$elm_css$Css$none = {ax: 0, ck: 0, u: 0, c: 0, k: 0, dZ: 0, cL: 0, b0: 0, aL: 0, al: 0, M: 0, e: 0, d: 0, b2: 0, bN: 0, ek: 0, G: 0, bO: 0, eu: 0, aT: 0, au: 0, y: 0, j: 0, eJ: 0, Q: 'none'};
...
var $rtfeldman$elm_css$Css$int = function (val) {
	return {
		...
		aY: '',
		bp: 0,
		Q: $elm$core$String$fromInt(val)
	};
};
var $rtfeldman$elm_css$Css$marginBottom = $rtfeldman$elm_css$Css$prop1('margin-bottom');
var $rtfeldman$elm_css$Css$marginRight = $rtfeldman$elm_css$Css$prop1('margin-right');
var $rtfeldman$elm_css$Css$move = {c: 0, Q: 'move'};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$toPosition = function (event) {
	return {r: event.cq.a, br: event.cq.b};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-testid', 'dragHandle-' + columnConfig.b.d_)
			]),
		A2(
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewFilter = F2(
	function (model, columnConfig) {
		return A2(
			...
			_List_fromArray(
				[
					A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-testid', 'filter-' + columnConfig.b.d_),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Css$width(
							$rtfeldman$elm_css$Css$px(columnConfig.b.eL - ($Orange_OpenSource$elm_advanced_grid$Grid$cumulatedBorderWidth * 2)))
						])),
					...
					A2($elm$core$Maybe$withDefault, '', columnConfig.x))
				]),
			_List_Nil);
	});
...
var $rtfeldman$elm_css$Css$colResize = {c: 0, Q: 'col-resize'};
...
var $rtfeldman$elm_css$Css$transparent = {I: 0, Q: 'transparent'};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewSortingSymbol = F2(
	function (model, columnConfig) {
		...
		if (!_v0.$) {
			var config = _v0.a;
			return _Utils_eq(config.b.d_, columnConfig.b.d_) ? ((model.an === 2) ? $Orange_OpenSource$elm_advanced_grid$Grid$viewArrowUp : $Orange_OpenSource$elm_advanced_grid$Grid$viewArrowDown) : $Orange_OpenSource$elm_advanced_grid$Grid$noContent;
		} else {
...
var $rtfeldman$elm_css$Css$italic = {aF: 0, Q: 'italic'};
var $rtfeldman$elm_css$Css$normal = {bZ: 0, aF: 0, W: 0, b4: 0, Q: 'normal', ae: 0};
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewTitle = F2(
	function (model, columnConfig) {
		var titleFontStyle = function () {
			...
			if (!_v0.$) {
				var column = _v0.a;
				return _Utils_eq(column.b.d_, columnConfig.b.d_) ? $rtfeldman$elm_css$Css$fontStyle($rtfeldman$elm_css$Css$italic) : $rtfeldman$elm_css$Css$fontStyle($rtfeldman$elm_css$Css$normal);
			} else {
		...
		return A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text(columnConfig.b.eF)
				]));
	});
							...
							[
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Css$overflow($rtfeldman$elm_css$Css$hidden),
										$rtfeldman$elm_css$Css$width(
										$rtfeldman$elm_css$Css$px((columnConfig.b.eL - $Orange_OpenSource$elm_advanced_grid$Grid$cumulatedBorderWidth) - $Orange_OpenSource$elm_advanced_grid$Grid$resizingHandleWidth))
									]))
							]),
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewGhostHeader = function (model) {
	...
	if (!_v0.$) {
		...
		return A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Css$px(draggedColumn.r - model.bA.r)),
			...
			_List_fromArray(
				[
					A3($Orange_OpenSource$elm_advanced_grid$Grid$viewDataHeader, model, draggedColumn.a2, _List_Nil)
				]));
	} else {
		return $Orange_OpenSource$elm_advanced_grid$Grid$noContent;
	}
	...
	function (model, currentColumn) {
		...
		if (!_v0.$) {
			...
			return _Utils_ap(
				...
				A2($Orange_OpenSource$elm_advanced_grid$Grid$isColumn, currentColumn, draggedColumn.a2) ? _List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[
					...
					[
						...
						$mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onEnter(
							function (_v1) {
								return A2($Orange_OpenSource$elm_advanced_grid$Grid$UserSwappedColumns, currentColumn, draggedColumn.a2);
							}))
					]));
		} else {
			return _List_Nil;
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$width(
							$rtfeldman$elm_css$Css$px($Orange_OpenSource$elm_advanced_grid$Grid$selectionColumn.b.eL - $Orange_OpenSource$elm_advanced_grid$Grid$cumulatedBorderWidth)),
							$rtfeldman$elm_css$Css$displayFlex,
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewHeader = F3(
	function (model, columnConfig, index) {
		var headerId = 'header-' + columnConfig.b.d_;
		var conditionalAttributes = _Utils_eq(model.ab, $elm$core$Maybe$Nothing) ? _List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Events$onClick(
		...
		var attributes = _List_fromArray(
			[
				...
				$Orange_OpenSource$elm_advanced_grid$Grid$headerStyles(model),
				$rtfeldman$elm_css$Html$Styled$Attributes$title(columnConfig.b.eG)
			]);
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
		...
		[
			...
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Css$displayFlex,
					$rtfeldman$elm_css$Css$height(
					$rtfeldman$elm_css$Css$px(model.h.dX))
				])),
...
var $FabienHenon$elm_infinite_list_view$InfiniteList$lazyView = F3(
	function (configValue, _v0, items) {
		...
		var skipCount = _v1.bR;
		var elements = _v1.bx;
		var topMargin = _v1.ac;
		var totalHeight = _v1.bm;
...
var $FabienHenon$elm_infinite_list_view$InfiniteList$view = F3(
	function (configValue, model, list) {
		var createContainer = function (l) {
			return {
				ba: $FabienHenon$elm_infinite_list_view$InfiniteList$listIter(l),
				bc: function (_v0) {
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Css$height(
								$rtfeldman$elm_css$Css$px(model.h.dI)),
								$rtfeldman$elm_css$Css$width(
								$rtfeldman$elm_css$Css$px(
									$Orange_OpenSource$elm_advanced_grid$Grid$gridWidth(model))),
...
var $Orange_OpenSource$elm_advanced_grid$Grid$viewGrid = function (model) {
	var conditionalAttributes = ((!_Utils_eq(model.ab, $elm$core$Maybe$Nothing)) || (!_Utils_eq(model.C, $elm$core$Maybe$Nothing))) ? _List_fromArray(
		[
	...
	var attributes = _List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$width(
					$rtfeldman$elm_css$Css$px(model.h.dJ + $Orange_OpenSource$elm_advanced_grid$Grid$cumulatedBorderWidth)),
...
var $rtfeldman$elm_css$Css$pointer = {c: 0, Q: 'pointer'};
...
var $rtfeldman$elm_css$Css$valuesOrNone = function (list) {
	return $elm$core$List$isEmpty(list) ? {Q: 'none'} : {
		Q: A2(
			$elm$core$String$join,
			' ',
			A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$id(columnConfig.b.d_),
						$rtfeldman$elm_css$Html$Styled$Attributes$type_('checkbox'),
						$rtfeldman$elm_css$Html$Styled$Attributes$checked(columnConfig.b.av),
						$rtfeldman$elm_css$Html$Styled$Events$onClick(
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Html$Styled$Attributes$for(columnConfig.b.d_)
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(columnConfig.b.eF)
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$px(5)),
						$rtfeldman$elm_css$Css$width(
						$rtfeldman$elm_css$Css$px(model.h.dJ * 0.6))
					]))
			]),
		A2(
			$elm$core$List$cons,
...
var $Orange_OpenSource$elm_advanced_grid$Grid$view = function (model) {
	return $rtfeldman$elm_css$Html$Styled$toUnstyled(
		model.bi ? $Orange_OpenSource$elm_advanced_grid$Grid$viewPreferences(model) : $Orange_OpenSource$elm_advanced_grid$Grid$viewGrid(model));
};
var $author$project$Main$viewGridArea = function (model) {
	var _v0 = model.D;
	if (!_v0.$) {
		var gm = _v0.a;
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id('grid-container')
				]),
			_List_fromArray(
				[
					A2(
					$elm$html$Html$map,
					$author$project$Main$GridMsg,
		...
		if (!_v1.$) {
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('empty-state')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$style, 'color', 'var(--error)')
							]),
						_List_fromArray(
							[
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Select a table from the sidebar')
							]))
					]));
		}
	}
...
var $author$project$Main$rowCountText = function (model) {
	var count = $elm$core$List$length(model.aN);
	var colCount = A2(
		$elm$core$Maybe$withDefault,
		0,
		A2(
...
var $author$project$Main$viewBadge = function (model) {
	var _v0 = model.aO;
	if (!_v0.$) {
		var schema = _v0.a;
		return schema.cv ? A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id('table-badge'),
					$elm$html$Html$Attributes$class('editable')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('EDITABLE')
				])) : A2(
			$elm$html$Html$span,
			_List_fromArray(
				[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('table-name')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$core$Maybe$withDefault, '', model.as))
					])),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('table-info')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Main$rowCountText(model))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('toolbar-right')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$placeholder('Search rows...'),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('sidebar-toggle'),
						$elm$html$Html$Events$onClick($author$project$Main$ToggleSidebar),
						$elm$html$Html$Attributes$title('Show sidebar')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('\u203A')
				...
				$author$project$Main$viewGridArea(model)
			]));
};
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $elm$html$Html$nav = _VirtualDom_node('nav');
var $author$project$Main$SelectTable = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$viewTableItem = F2(
	function (selected, t) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					_Utils_eq(
						selected,
						$elm$core$Maybe$Just(t.A)) ? 'table-item active' : 'table-item'),
					$elm$html$Html$Events$onClick(
					$author$project$Main$SelectTable(t.A))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(t.A)
						]))
				]));
	});
var $author$project$Main$viewTableGroups = function (model) {
	var viewGroup = F2(
		function (label, items) {
			return $elm$core$List$isEmpty(items) ? _List_Nil : _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('section-group')
						]),
					A2(
						$elm$core$List$cons,
						A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('section-label')
								]),
							_List_fromArray(
								[
						...
						A2(
							$elm$core$List$map,
							$author$project$Main$viewTableItem(model.as),
							items)))
				]);
		});
	var master = A2(
		$elm$core$List$filter,
		function (t) {
			return (!A2($elm$core$String$startsWith, 'canvas_', t.A)) && (!A2($elm$core$String$startsWith, 'gh_', t.A));
		},
		model.aS);
	var github = A2(
		$elm$core$List$filter,
		function (t) {
			return A2($elm$core$String$startsWith, 'gh_', t.A);
		},
		model.aS);
	var canvas = A2(
		$elm$core$List$filter,
		function (t) {
			return A2($elm$core$String$startsWith, 'canvas_', t.A);
		},
		model.aS);
	return _Utils_ap(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('sidebar-header')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('cass')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('collapse-btn'),
								$elm$html$Html$Events$onClick($author$project$Main$ToggleSidebar),
								$elm$html$Html$Attributes$title('Collapse sidebar')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('\u2039')
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('table-list')
					]),
				$author$project$Main$viewTableGroups(model))
			]));
};
