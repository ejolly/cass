...
def _make_page(conn: duckdb.DuckDBPyConnection):
...
# ===========================================================================
# Phase 2A: Modal classes are importable
# ===========================================================================
...
# ===========================================================================
# Phase 2B: Modal classes take ViewerPage and have .open()
# ===========================================================================
...
# ===========================================================================
# Phase 2C: Modal rendering with NiceGUI User fixture
# ===========================================================================


async def test_push_modal_renders_title(
...
async def test_create_assignment_modal_renders_title(
    user: User, ui_conn: duckdb.DuckDBPyConnection
) -> None:
    from cass.viewer.modals.create_assignment import CreateAssignmentModal
...
async def test_create_assignment_modal_has_form_fields(
    user: User, ui_conn: duckdb.DuckDBPyConnection
) -> None:
    from cass.viewer.modals.create_assignment import CreateAssignmentModal
...
async def test_delete_assignment_modal_renders_title(
    user: User, ui_conn: duckdb.DuckDBPyConnection
) -> None:
    from cass.viewer.modals.delete_assignment import DeleteAssignmentModal
...
async def test_delete_assignment_modal_has_select_and_buttons(
    user: User, ui_conn: duckdb.DuckDBPyConnection
) -> None:
    from cass.viewer.modals.delete_assignment import DeleteAssignmentModal
...
async def test_pull_gh_modal_renders_title(
    user: User, ui_conn: duckdb.DuckDBPyConnection
) -> None:
    from cass.viewer.modals.pull_gh import PullGHModal
