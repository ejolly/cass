...
from cass.viewer import canvas_apply, canvas_preview
...
@pytest.fixture
def sync_conn():
    """In-memory DuckDB with schema for canvas sync tests."""
...
def _make_assignment(
    ...
    """Create a mock CanvasAssignment-like object."""
...
class TestPreviewAssignments:
    ...
    def test_no_conflicts(self, sync_conn):
        ...
        from cass.viewer import preview_assignments
...
class TestPreviewGrades:
    ...
    def test_no_conflicts(self, sync_conn):
        ...
        from cass.viewer import preview_grades
...
class TestCanvasPreview:
    ...
    def test_combines_assignment_and_grade_previews(self, sync_conn):
        ...
        with patch("cass.canvas.client.CanvasClient") as MockClient:
