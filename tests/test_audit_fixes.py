...
class TestCanvasEnrichedQueries:
    ...
    def canvas_db(self, db_conn):
        ...
        db.save_canvas_assignments(
            ...
            group_names={0: "Assignments"},
        )
        from cass.models import CanvasGrade, CanvasSubmission
    ...
    def test_canvas_submissions_missing_student(self, canvas_db):
        ...
        from cass.models import CanvasSubmission
...
class TestDbHelpers:
    ...
    def test_get_assignment_groups(self, db_conn):
        db.save_canvas_assignments(
            [
                CanvasAssignment(
                    id=1, name="HW1", points_possible=10.0, assignment_group_id=0
                ),
                CanvasAssignment(
                    id=2, name="HW2", points_possible=10.0, assignment_group_id=1
                ),
                CanvasAssignment(
                    id=3, name="HW3", points_possible=10.0, assignment_group_id=0
                ),
            ],
            group_names={0: "Homework", 1: "Exams"},
        )
...
class TestGetEnrichedRows:
    ...
    def enriched_db(self, db_conn):
        ...
        db.save_canvas_assignments(
            ...
            group_names={0: "Homework"},
        )
        from cass.models import CanvasGrade
