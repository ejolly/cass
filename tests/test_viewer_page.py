...
def _make_ui_conn() -> duckdb.DuckDBPyConnection:
...
@pytest.fixture
def ui_conn() -> duckdb.DuckDBPyConnection:  # ty: ignore[invalid-return-type]
    conn = _make_ui_conn()
    yield conn
    conn.close()
...
# ===========================================================================
# Phase 1: ViewerPage — class instantiation and state
# ===========================================================================
...
class TestViewerPageInit:
    ...
    def test_has_instance_attrs(self, ui_conn: duckdb.DuckDBPyConnection):
    ...
    def test_default_table_canvas_grades(self, ui_conn: duckdb.DuckDBPyConnection):
    ...
    def test_pending_loaded(self, ui_conn: duckdb.DuckDBPyConnection):
    ...
    def test_sidebar_items_empty_before_build(self, ui_conn: duckdb.DuckDBPyConnection):
...
# ===========================================================================
# Phase 2: Component classes exist and take ViewerPage
# ===========================================================================
...
# ===========================================================================
# Phase 2b: Component rendering with NiceGUI User fixture
# ===========================================================================


async def test_sidebar_renders_course_name(
...
async def test_sidebar_renders_table_groups(
    user: User, ui_conn: duckdb.DuckDBPyConnection
) -> None:
...
async def test_sidebar_populates_sidebar_items(
    user: User, ui_conn: duckdb.DuckDBPyConnection
) -> None:
...
async def test_sidebar_sets_pending_badge(
    user: User, ui_conn: duckdb.DuckDBPyConnection
) -> None:
...
async def test_toolbar_renders_labels(
    user: User, ui_conn: duckdb.DuckDBPyConnection
) -> None:
...
async def test_toolbar_has_export_buttons(
    user: User, ui_conn: duckdb.DuckDBPyConnection
) -> None:
...
async def test_grid_panel_creates_container(
    user: User, ui_conn: duckdb.DuckDBPyConnection
) -> None:
...
# ===========================================================================
# Phase 3: Full render with NiceGUI User fixture
# ===========================================================================


async def test_viewer_page_renders(
    user: User, ui_conn: duckdb.DuckDBPyConnection
) -> None:
...
async def test_viewer_page_sidebar_navigation(
    user: User, ui_conn: duckdb.DuckDBPyConnection
) -> None:
...
async def test_viewer_page_pending_display(
    user: User, ui_conn: duckdb.DuckDBPyConnection
) -> None:
...
# ===========================================================================
# Phase 4: Backward compatibility — existing imports still work
# ===========================================================================
